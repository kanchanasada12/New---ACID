...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "qcUmVCKA#iel7q0j-yZ eXIZ33SOR6pzp090ijM9_PAY93Jb7Mg04", // session id  
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "94764639572", // ඔයාගෙ නම්බර් එක
OWNER_EMOJI: process.env.OWNER_EMOJI || "⛁", // ඉමෝජි
BOT_NAME: process.env.BOT_NAME || "*𝗔𝗖𝗜𝗗-𝔏𝔖*", // බොට් නම
...
OWNER_NAME: process.env.OWNER_NAME || "Kanchana Sadaruwan", // නම
FOOTER: process.env.FOOTER || "> *ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴷᴬᴺᶜᴴᴬᴺᴬ ˢᴬᴰᴬᴿᵁᵂᴬᴺ  👨‍💻*",
